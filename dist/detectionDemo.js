...
exports.demoBallDetectionSystem = demoBallDetectionSystem;
const PositionTrackingService_1 = require("./services/detection/PositionTrackingService");
const BallDetector_1 = require("./services/detection/BallDetector");
const BallTracker_1 = require("./services/detection/BallTracker");
...
async function demoBallDetectionSystem() {
    ...
    const ballDetector = new BallDetector_1.BallDetector({
        minConfidence: 0.6,
        minBallRadius: 8
    });
    const testFrame = {
    ...
    const ballTracker = new BallTracker_1.BallTracker();
...
//# sourceMappingURL=detectionDemo.js.map