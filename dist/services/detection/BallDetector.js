...
class BallDetector {
    ...
    applyColorThreshold(hsvImage) {
        ...
        for (let i = 0; i < hsvImage.data.length; i += 3) {
            ...
            const inRange = (h >= hsvLower[0] && h <= hsvUpper[0] &&
     ...
     */
    findBallCandidates(maskImage, cameraId) {
     ...
     */
    validateAndScoreDetections(candidates, frame) {
        const detections = [];
     ...
     */
    calculateBallProperties(candidate, frame) {
...
exports.BallDetector = BallDetector;
// Default parameters optimized for yellow Padel ball
BallDetector.DEFAULT_PARAMS = {
...
//# sourceMappingURL=BallDetector.js.map