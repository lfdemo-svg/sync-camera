...
class SyncCalibrator {
     ...
     */
    static generateInstructions(methodId) {
     ...
     */
    static createLEDFlashEvent(description = 'LED flash sync') {
        return {
     ...
     */
    static createAudioBeepEvent(description = 'Audio beep sync') {
        return {
            eventId: this.generateEventId(),
     ...
     */
    static createQRCodeEvent(timestamp) {
     ...
     */
    static generateQRCodeData(timestamp) {
        const syncTime = timestamp || Date.now();
     ...
     */
    static validateSyncEvent(event) {
        const issues = [];
     ...
     */
    static calculateSyncAccuracy(calibration) {
        const cameraAccuracies = new Map();
        let totalError = 0;
     ...
     */
    static generateCalibrationReport(calibration) {
...
exports.SyncCalibrator = SyncCalibrator;
SyncCalibrator.CALIBRATION_METHODS = [
    {
        id: 'led_flash',
        name: 'LED Flash Sync',
...
//# sourceMappingURL=SyncCalibrator.js.map