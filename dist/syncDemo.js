...
exports.demoSynchronizationSystem = demoSynchronizationSystem;
const SynchronizationService_1 = require("./services/sync/SynchronizationService");
const SyncCalibrator_1 = require("./services/sync/SyncCalibrator");
async function demoSynchronizationSystem() {
    ...
    const syncService = new SynchronizationService_1.SynchronizationService(cameraIds, {
        maxBufferSize: 300,
        targetLatency: 50,
        maxJitter: 16
    });
    ...
    const qrData = SyncCalibrator_1.SyncCalibrator.generateQRCodeData();
    console.log('QR Code sync data:');
    console.log(qrData);
    // Test sync event validation
    const testEvent = SyncCalibrator_1.SyncCalibrator.createLEDFlashEvent('Test LED flash');
    ...
    const validation = SyncCalibrator_1.SyncCalibrator.validateSyncEvent(testEvent);
